##############################################################################
# File-Name: 07_robustness_discrete.R
# author: Tiago Ventura
# Purpose: offline isolation robustness with discrete partisanship assignment
# Data in: data/matched_voters_segregation_discrete.json
# Data out: SI Figure 9 (bottom panel)
##############################################################################
...
temp_path <- file.path(data_path, "matched_voters_segregation_discrete.json")
...
save_function("sm_fig_9b.png")
save_function("sm_fig_9b.pdf")
